...
(let* (
      ...
      (guava-themes-ceiba-shadow            "#b3b3b3")

      (guava-themes-ceiba-light-gray        "#d4d4d4");dcdcdc
      (guava-themes-ceiba-gray-green        "#817a6a");8c857b,8d8d8b,8c7f76,817a68
      (guava-themes-ceiba-gray              "#787882");dcdcdc,656865,7f7f89
      (guava-themes-ceiba-gray-blue         "#656865");8c857b,8d8d8b,6d726a

      (guava-themes-ceiba-light-green       "#5b6452");5a6352
      (guava-themes-ceiba-green             "#276452");5a6352
      (guava-themes-ceiba-deep-green        "#375535");375033,395235,3a5435,3a5835,385635

      (guava-themes-ceiba-orange            "#a85639")

      (guava-themes-ceiba-steel-blue        "#b0c4de")
  ...
  (custom-theme-set-faces
   ...
   `(default ((,guava-themes-ceiba-class (:foreground ,guava-themes-ceiba-light-gray :background ,guava-themes-ceiba-gray-green))))
   ...
   ;; cursor
   `(cursor ((,guava-themes-ceiba-class (:background ,guava-themes-ceiba-light-gray :foreground ,guava-themes-ceiba-black))))

   ;; fringe
   `(fringe ((,guava-themes-ceiba-class (:background ,guava-themes-ceiba-gray-green :foreground ,guava-themes-ceiba-white))))
   ...
   `(guava-themes-visible-bell ((,guava-themes-ceiba-class (:background ,guava-themes-ceiba-deep-green :foreground ,guava-themes-ceiba-white))))

   ;; minibuffer
   `(minibuffer-prompt ((,guava-themes-ceiba-class (:foreground ,guava-themes-ceiba-white))))
   ...
   `(font-lock-type-face ((,guava-themes-ceiba-class (:foreground ,guava-themes-ceiba-green :weight medium))))
   `(font-lock-constant-face ((,guava-themes-ceiba-class (:foreground ,guava-themes-ceiba-orange :weight medium))))
   `(font-lock-function-name-face ((,guava-themes-ceiba-class (:foreground ,guava-themes-ceiba-steel-blue :weight medium))))
