...
(let* (
      ...
      (guava-prunus-light-purple      "#")
      (guava-prunus-purple            "#");984ee6
  ...
  (custom-theme-set-faces
   ...
   ;; ;; line-number
   ;; `(line-number ((,guava-prunus-class (:foreground ,guava-prunus-antarctic-blue :height 1.35))))
   ;; `(line-number-current-line ((,guava-prunus-class (:foreground ,guava-prunus-black :background ,guava-prunus-light-purple :weight bold :height 1.35))))
   ...
   ;; `(mode-line-inactive ((,guava-prunus-class (:background ,guava-prunus-light-blue :foreground ,guava-prunus-white))))
   ;; `(guava-visible-bell ((,guava-prunus-class (:background ,guava-prunus-orange :foreground ,guava-prunus-white))))

   ;; minibuffer
   `(minibuffer-prompt ((,guava-prunus-class (:foreground ,guava-prunus-white))))

   ;; ;; borders
   ;; `(vertical-border ((,guava-prunus-class (:foreground ,guava-prunus-light-purple))))

   ;; ;; header-line
   ;; `(header-line ((,guava-prunus-class (:background ,guava-prunus-deep-blue :foreground ,guava-prunus-white))))
   ;; `(which-func ((,guava-prunus-class (:background ,guava-prunus-deep-blue :foreground ,guava-prunus-white))))

   ;; ;; tab-bar
   ;; `(tab-bar ((,guava-prunus-class (:background ,guava-prunus-purple :foreground ,guava-prunus-white))))
   ;; `(tab-bar-tab ((,guava-prunus-class (:background ,guava-prunus-deep-blue :foreground ,guava-prunus-white :weight bold :height 1.0))))
   ;; `(tab-bar-tab-inactive ((,guava-prunus-class (:background ,guava-prunus-purple :foreground ,guava-prunus-white :weight bold :height 1.0))))

   ;; ;; tab-line
   ;; `(tab-line ((,guava-prunus-class (:background ,guava-prunus-purple :foreground ,guava-prunus-white))))
   ;; `(tab-line-tab ((,guava-prunus-class (:background ,guava-prunus-purple :foreground ,guava-prunus-white :weight bold :height 0.9))))
   ;; `(tab-line-tab-current ((,guava-prunus-class (:background ,guava-prunus-deep-blue :foreground ,guava-prunus-white :weight bold :height 0.9))))
   ;; `(tab-line-tab-inactive ((,guava-prunus-class (:background ,guava-prunus-purple :foreground ,guava-prunus-white :weight bold :height 0.9))))
   ;; `(tab-line-tab-modified ((,guava-prunus-class (:foreground ,guava-prunus-orange :weight bold :height 0.9))))
   ...
   `(font-lock-type-face ((,guava-prunus-class (:foreground ,guava-prunus-oceanic-green :weight medium))))
   ...
   ;; ;; parentheses
   ;; `(show-paren-match ((,guava-prunus-class (:background ,guava-prunus-orange))))

   ;; ;; buttons
   ;; `(link ((,guava-prunus-class (:foreground ,guava-prunus-oceanic-green :underline t :weight bold))))
   ;; `(link-visited ((,guava-prunus-class (:foreground ,guava-prunus-deep-green :underline t :weight bold))))
